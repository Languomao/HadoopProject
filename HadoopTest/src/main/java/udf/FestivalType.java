...
public class FestivalType extends UDF {
    ...
    public FestivalType() throws IOException {
        InputStreamReader proFile = new InputStreamReader(getClass().getClassLoader().getResourceAsStream("festival_date.properties"));
    ...
    public String evaluate(String date_str){
        if(!match_date(date_str).equals("null")){
