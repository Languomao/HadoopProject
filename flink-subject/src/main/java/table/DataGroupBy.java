...
public class DataGroupBy {
    public static void main(String[] args) throws Exception{
        ...
        Table groupbysql = tableEnv.sqlQuery("select DestinationIP,count(MSISDN) as count_num from httptable group by DestinationIP");

        //转换回dataset
        DataSet<Result> result = tableEnv.toDataSet(groupbysql, Result.class);
        ...
        result.map(new MapFunction<Result, Tuple2<String,String>>() {
            ...
            public Tuple2<String,String> map(Result result) throws Exception {
                ...
                String value = result.count_num.toString();
