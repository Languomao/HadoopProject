...
public class DataTest2 {
    public static void main(String[] args) throws Exception{
        ...
        DataSet<String> input2 = env.readTextFile("D:\\data\\video1w");
        ...
        Table joinsql = tableEnv.sqlQuery("select MSISDN,DestinationIP from httptable order by MSISDN");
        //转换回dataset
        /*DataSet<Tuple2<HttpObject,VideoObject>> result = httpInput.join(httpInput2).where("MSISDN")
                .equalTo("MSISDN");*/
        ...
        result.map(new MapFunction<Result, Tuple2<String,String>>() {
            ...
            public Tuple2<String,String> map(Result result) throws Exception {
                String key = result.DestinationIP;
                String value = result.MSISDN;
