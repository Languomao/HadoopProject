...
public class TableSQL {
    public static void main(String[] args) throws Exception{
        ...
        Table selectall = tableEnv.sqlQuery("select count(*) as num from httptable");

        //转换回dataset
        DataSet<Result> result = tableEnv.toDataSet(selectall, Result.class);
        ...
        result.map(new MapFunction<Result, Tuple2<String,String>>() {
            ...
            public Tuple2<String,String> map(Result result) throws Exception {
                String count = "SUM";
                String num = result.num.toString();
                return Tuple2.of(count,num);
            }
        }).print();
    }
