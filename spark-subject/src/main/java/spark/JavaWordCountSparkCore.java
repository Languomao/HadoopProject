...
/**
 * Classname JavaWordCountSparkCore
 * Description TODO
...
public class JavaWordCountSparkCore {
    public static void main(String[] args) {
        ...
        // 3. 从hdfs读取文件形成RDD
        // TODO: 文件路径自行给定
        JavaRDD<String> rdd = sc.textFile("C:\\Users\\LanKorment\\Desktop\\note.txt");
        ...
        resultRDD.foreachPartition(new VoidFunction<java.util.Iterator<Tuple2<String, Integer>>>() {
            ...
            public void call(Iterator<Tuple2<String, Integer>> tuple2Iterator) throws Exception {
                ...
                String url = "jdbc:mysql://10.1.1.7:3306/test";
                String username = "root";
                String password = "hadoop123";
